  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // is not restarted.
        primarySwatch: Colors.blue, // A simpler way to set the primary color theme
      ),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    // setState is a method that tells Flutter that something in the State has changed,
    // which causes it to rerun the build method below so that the display can
